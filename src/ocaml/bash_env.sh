...
PKGS="-package num,yojson,ppx_deriving_yojson,batteries,bos.setup,ppx_assert,ppx_assert.runtime-lib,sexplib,core,lru-cache"
...
mls="x_string.ml gen_isa.ml our.ml btree.ml test.ml int_int_store.ml test_ii.ml"
cmos="${mls//.ml/.cmo}"
cmxs="${mls//.ml/.cmx}"
